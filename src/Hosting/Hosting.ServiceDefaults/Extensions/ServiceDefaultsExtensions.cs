...
using ContractHealthEntry = Workbench.Contracts.Observability.Health.HealthCheckEntry;
using ContractHealthReport = Workbench.Contracts.Observability.Health.HealthCheckResponse;
