...
/// </summary>
internal sealed class ComparisonTopologyBuilder {
    private readonly List<ComparisonTopologyNodeBuilder> children = [];
    ...
    public ComparisonTopologyBuilder AddGroup(
        string id,
        string displayName,
        Action<ComparisonTopologyNodeBuilder> configure) {
        ...
        var group = new ComparisonTopologyNodeBuilder(
            id,
            displayName,
    ...
    internal IReadOnlyList<ComparisonTopologyNodeBuilder> Children => children;
...
/// </summary>
internal sealed class ComparisonTopologyNodeBuilder {
    private readonly List<ComparisonTopologyNodeBuilder> children = [];
    private readonly Action<string> registerNodeId;

    internal ComparisonTopologyNodeBuilder(
        string id,
        string displayName,
    ...
    public ComparisonTopologyNodeBuilder AddService(
        IResourceBuilder<ProjectResource> resource,
        string displayName,
        Action<ComparisonTopologyNodeBuilder>? configure = null,
        TopologyDependencyRequirement requirement =
            TopologyDependencyRequirement.Required) {
        ...
        var service = new ComparisonTopologyNodeBuilder(
            id,
            displayName,
    ...
    /// <returns>The current node builder.</returns>
    public ComparisonTopologyNodeBuilder AddStorage(
        string id,
        string displayName,
        TopologyDependencyRequirement requirement =
            TopologyDependencyRequirement.Required) {
        ...
        registerNodeId(id);
        children.Add(new ComparisonTopologyNodeBuilder(
            id,
            displayName,
