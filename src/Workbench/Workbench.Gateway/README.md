...
├── Dockerfile
├── Program.cs
├── Workbench.Gateway.csproj
├── Clients/
│   ├── HttpServiceClient.cs
│   ├── IServiceClient.cs
│   ├── MicroservicesServiceClient.cs
│   └── VirtualActorsServiceClient.cs
├── Configuration/
│   └── ServiceEndpointOptions.cs
├── Endpoints/
│   └── ScenarioEndpoints.cs
├── Extensions/
│   └── CorrelationIdApplicationBuilderExtensions.cs
├── Observability/
│   └── Logging/
│       ├── LogError.cs
│       ├── LogInformation.cs
