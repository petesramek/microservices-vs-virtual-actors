...
internal sealed class OrderingDatabaseHealthCheck(
    ...
    public async Task<HealthCheckResult> CheckHealthAsync(
        ...
        if (string.IsNullOrWhiteSpace(connectionString)) {
            return HealthCheckResult.Unhealthy("The Ordering database connection string is not configured.");
        }
        ...
        try {
            ...
            await using (connection.ConfigureAwait(false)) {
                ...
                await using (command.ConfigureAwait(false)) {
                    ...
                    return HealthCheckResult.Healthy("The Ordering database is available.");
                }
            }
