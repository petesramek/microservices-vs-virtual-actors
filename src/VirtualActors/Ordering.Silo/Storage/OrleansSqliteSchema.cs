...
/// <summary>
/// Contains the SQLite schema required by Orleans grain persistence.
/// </summary>
internal static class OrleansSqliteSchema {
    /// <summary>
    /// Gets the shared Orleans SQLite schema.
    /// </summary>
    ...
    /// <summary>
    /// Gets the schema that creates the Orleans grain storage table and
    /// registers the SQLite persistence queries.
    /// </summary>
