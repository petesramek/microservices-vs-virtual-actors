...
```text
Ordering.Grains.csproj

Contracts/
  GrainOrderResult.cs
  InventoryReservationResult.cs
  InventorySnapshot.cs
  PaymentAuthorizationResult.cs

Grains/
  InventoryItemGrain.cs
  OrderGrain.cs
  PaymentAccountGrain.cs

  Abstraction/
    IInventoryItemGrain.cs
    IOrderGrain.cs
    IPaymentAccountGrain.cs

State/
  InventoryItemState.cs
  OrderState.cs
  PaymentAccountState.cs
```
